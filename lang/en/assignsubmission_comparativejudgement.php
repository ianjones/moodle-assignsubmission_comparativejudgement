...
$string['left'] = 'Left';
$string['loosingsubmission'] = 'Loosing submission';
$string['loosingsubmissionid'] = 'Loosing submission';
...
$string['pathtorscript'] = 'Path to Rscript (optional)';
$string['pathtorscript_help'] = 'If left empty, scores are computed using a built-in PHP implementation of the Bradley-Terry model. Set this only if you have R and the sirt package installed and prefer to use the original R script.';
