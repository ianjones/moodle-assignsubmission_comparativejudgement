 ...
 */
class comparison_made extends base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' made a comparison $this->objectid.";
    }
    ...
    public static function get_name() {
        return get_string('event:comparisonmade', 'local_certification');
    }
